...
OPTIONAL OPTIONS:
    ...
    --work-dir <path>         工作目录（默认: /root/yak-ssa-benchmark）
...
EXAMPLES:
    ...
    $0 --service-name yak-embedding-service \\
       --main-script /root/yak-ssa-benchmark/apps/ssa-benchmark/report_viewer.yak \\
       --config-file /root/yak-ssa-benchmark/apps/ssa-benchmark/.env \\
